...
1. Check the [existing issues](https://github.com/Eng-MinaAshraf/Dental-ERP/issues) to avoid duplicates
...
Open a [Discussion](https://github.com/Eng-MinaAshraf/Dental-ERP/discussions) for general questions.
